...
<div class="container">
    ...
    <p>Click image to zoom and have access to specialist segmentation. Select images and segmentation specialist from list for download (available soon)</p>
...
<div class="modal fade hidden" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <hr />
		...
		if(isset($_GET['pesquisar'])){
         ...
         $imagem->getImagemsTable($pesquisar); ?>
    <hr />
